import { type Conforms, conforms, def, many, of, oneOf, pick } from "codeform";
...
export const _account: Conforms<typeof account, typeof spec.account, "account"> = conforms<typeof account, typeof spec.account, "account">();
...
export const _plan: Conforms<typeof plan, typeof spec.plan, "plan"> = conforms<typeof plan, typeof spec.plan, "plan">();
